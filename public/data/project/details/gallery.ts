...
const contribution: Array<ContributionType> = [
  {
    ...
    description: [
      ...
      '촬영된 사진을 Firebase에 업로드 및 관리하고, 이를 무한 스크롤 페칭 로직 구현',
    ],
  },
  {
...
export const details: ProjectDetailType = {
  ...
  당시 개발 초창기로, React의 초석만 알고 있는 상태로 프로젝트를 진행하였다 보니 무엇을 만드는지, 어떻게 만들어야 하는지에 대한 충분한 고민없이 진행되었다고 생각합니다.<br/><br/>
  학생들은 초상권에 대해 굉장히 부담스러워하였습니다. 따라서, 촬영된 사진에 대한 저장 기간 및 활용 목적을 명확하게 인지해드렸지만, 촬영된 사진을 개개인에게 전달해주는 과정이 포함되었으면 더 풍부한 이벤트가 되지 않았을까 싶습니다.
  `,
